...
public class DataSourceBuffer extends SourceBuffer implements DataSource {
	...
	@Override
	public DataSourceBuffer skipBytes(int bytes) {
		super.skipBytes(bytes);
		return this;
	}
	@Override
	public DataSourceBuffer rewindBytes(int bytes) {
		super.rewindBytes(bytes);
		return this;
	}
	@Override
	public DataSourceBuffer rewind() {
		super.rewind();
		return this;
	}
	@Override
	public DataSourceBuffer toMark() {
		super.toMark();
		return this;
	}
	@Override
	public DataSourceBuffer mark() {
		super.mark();
		return this;
	}
}
